...
// For URP 17+, cameraDepthTarget is obsolete, use cameraDepthTargetHandle (returns RTHandle)
// For URP 10-16, use cameraDepthTarget (returns RenderTargetIdentifier)
// For URP 9 and earlier, use cameraDepth
#if URP_17_0_OR_LATER
                        rtid = additionalCameraData.scriptableRenderer.cameraDepthTargetHandle;
#elif URP_10_0_OR_LATER
